            ...
            <div class="ud-brands wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="ud-brands-logo">
                <div class="ud-single-logo">
                  <img src="{{asset('assets-landing/images/brands/ayroui.svg')}}" alt="ayroui" />
                </div>
                <div class="ud-single-logo">
                  <img src="{{asset('assets-landing/images/brands/uideck.svg')}}" alt="uideck" />
                </div>
                <div class="ud-single-logo">
                  <img
                    src="{{asset('assets-landing/images/brands/graygrids.svg')}}"
                    alt="graygrids"
                  />
                </div>
                <div class="ud-single-logo">
                  <img
                    src="{{asset('assets-landing/images/brands/lineicons.svg')}}"
                    alt="lineicons"
                  />
                </div>
                <div class="ud-single-logo">
                  <img
                    src="{{asset('assets-landing/images/brands/ecommerce-html.svg')}}"
                    alt="ecommerce-html"
                  />
                </div>
              </div>
        ...
        <div class="row">
            ...
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".1s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{asset('assets-landing/images/team/team-01.png')}}" alt="team" />
                </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".15s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{asset('assets-landing/images/team/team-02.png')}}" alt="team" />
                </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".25s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{asset('assets-landing/images/team/team-04.png')}}" alt="team" />
                </div>
