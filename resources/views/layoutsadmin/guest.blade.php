    ...
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                <li><a class="m-link" href="{{ route('guesthome') }}"><i class="icofont-ui-home"></i><span>Home</span></a></li>
                <li><a class="m-link" href="{{ route('regissekolah') }}"><i class="icofont-plus-circle"></i><span>Daftarkan Sekolah</span></a></li>
            </ul>
