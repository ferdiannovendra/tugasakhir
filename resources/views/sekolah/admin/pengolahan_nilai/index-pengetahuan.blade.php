    ...
    <div class="col-md-12">
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <br>
                <button type="button" id="btnLihat" class="btn btn-primary" >Lihat Rincian Nilai Siswa</button>
                <button type="button" id="btnLihat" class="btn btn-primary" >Lihat Nilai Rapor</button>
