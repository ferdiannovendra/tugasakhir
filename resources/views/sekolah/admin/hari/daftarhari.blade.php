    ...
    <div class="col-md-12">
        <div class="card mb-3">
            <div class="card-header mt-2 py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                <h6 class="mb-0 fw-bold ">Daftar Hari</h6>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#TambahModal">Tambah Hari</button>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4" >Tambah Hari</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('postTambahHari') }}" method="post">
...
<script>
    ...
    swal({
        ...
        var act = '/sekolah/postHapusHari';
        $.post(act, { _token: token, idclass:id },
        function (data) {
            swal(
            'Terhapus!',
            'Data Hari telah terhapus.',
            'success'
            ).then(function () {
                location.reload();
            })
